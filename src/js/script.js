...
const atividade = {
    nome: "Almoço",
    data: new Date("2024-09-05 12:00"),
    finalizada: false
}
...
let atividades = [
    ...
    {
        nome: "Jantar",
        data: new Date("2024-09-05 19:00"),
        finalizada: false
    },

    {
        nome: "Academia",
        data: new Date("2024-09-06 09:00"),
        finalizada: false
    },
]
...
const atualizarListaDeAtividades = () => {
    ...
    if (atividades.length == 0) {
        section.innerHTML = `<p>Você não cadastrou nenhuma atividade.</p>`
        return
    }

    // loop, - para cada atividade de atividades escreverá no html até acabar todas atividade de atividades
